...
class Ui_Dialog(object):
    def get_data_into_database(self):
        ...
        result = cursor.fetchall()
        self.ValueUmidade.setText(str(result[0][2]))
        ...
        self.ValueSTP.setText(str(result[4][2]))
        ...
        self.ValueCranioCod.setText(conjunto['Crânio Fragmentado'])
        self.ValueCranioLoc.setText(conjunto['Crânio Ausente'])
        self.ValueMandQtde.setText(conjunto['Mandíbula Íntegro'])
        self.ValueMandCod.setText(conjunto['Mandíbula Fragmentado'])
        self.ValueMandLoc.setText(conjunto['Mandíbula Ausente'])
        self.ValueHioideQtde.setText(conjunto['Hióide Íntegro'])
        self.ValueHioideCod.setText(conjunto['Hióide Fragmentado'])
        self.ValueHioideLoc.setText(conjunto['Hióide Ausente'])
        self.ValueEsternoQtde.setText(conjunto['Esterno Íntegro'])
        self.ValueEsternoCod.setText(conjunto['Esterno Fragmentado'])
        self.ValueEsternoLoc.setText(conjunto['Esterno Ausente'])
        self.ValueSacroQtde.setText(conjunto['Sacro Íntegro'])
        self.ValueSacroCod.setText(conjunto['Sacro Fragmentado'])
        self.ValueSacroLoc.setText(conjunto['Sacro Ausente'])
    ...
    def setupUi(self, Dialog):
        ...
        self.ObsGeraisFinalLabel.setGeometry(QtCore.QRect(-30, 2400, 601, 41))
        self.ObsGeraisFinalLabel.setObjectName("ObsGeraisFinalLabel")
        self.textEdit = QtWidgets.QTextEdit(self.widget)
        self.textEdit.setGeometry(QtCore.QRect(20, 2440, 481, 71))
